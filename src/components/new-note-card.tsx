            ...
            <form className="flex-1 flex flex-col">
              ...
              {isRecording ? (
                ...
                <button
                  ...
                  className="w-full bg-lime-400 py-4 text-center text-sm text-lime-950 outline-none font-medium hover:bg-lime-500 disabled:text-slate-300 disabled:bg-slate-800 disabled:cursor-not-allowed"
                  disabled={content === ''}
                >
                  Salvar nota
                </button>
